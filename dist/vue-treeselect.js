/*!
 * vue-treeselect v0.0.38 | (c) 2017-2018 Riophae Lee
...
var INPUT_DEBOUNCE_DELAY = process.env.NODE_ENV === 'testing' ? 10 : 800;
...
/* harmony default export */ var treeselectMixin = ({
  ...
  methods: {
    ...
    handleLocalSearch: function handleLocalSearch() {
      ...
      var lowerCasedSearchQuery = searchQuery.trim().toLocaleLowerCase('tr-TR');
    ...
    normalize: function normalize(parentNode, nodes, prevNodeMap) {
      ...
      var normalizedOptions = nodes.map(function (node) {
        ...
        var lowerCased = _this16.matchKeys.reduce(function (prev, key) {
          return objectSpread_default()({}, prev, defineProperty_default()({}, key, stringifyOptionPropValue(node[key]).toLocaleLowerCase('tr-TR')));
        }, {});
